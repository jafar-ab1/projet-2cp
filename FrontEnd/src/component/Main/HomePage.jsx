...
<div className="container">
    ...
    <section className="Perfect-Stay-Container">
        ...
        <div className="LeftSide">
          ...
          <ul className="list">
            ...
            <button className="link" onClick={() => navigate("/Accommodation")}>Accommodation</button>
      ...
      <div className="OEW">
        <div className="Occasions"  style={{backgroundImage: `url(${Image3})`,}}>
            <p>Occasions</p>
        ...
        <div className="Wellness" style={{backgroundImage: `url(${Image5})`,}}>
            <p>Wellness</p>
      ...
      <div className="LeftSide2">
        ...
        <div className="RightSide2">
            ...
            <button className="link" onClick={() => navigate("/Dining")}>Dining</button>
    ...
    <section className="containerBottom" style={{ backgroundImage: `url(${Image6})` }}>
