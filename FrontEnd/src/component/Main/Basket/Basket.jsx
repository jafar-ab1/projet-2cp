          ...
          {reservedRooms.map((room, index) => (
            <div key={index}>
              <div className="RoomItem">
                ...
                <p>
                  {formatDate(retrievedData?.checkInDate)} -{' '}
                  {formatDate(retrievedData?.checkOutDate)}
                  {nights > 0 &&
                    ` (${nights} ${nights === 1 ? 'night' : 'nights'})`}
                </p>
                <p>
                  {retrievedData?.adults} Adults and {retrievedData?.children}{' '}
                  children
                </p>
                <p>You reserved {room.reserved} rooms.</p>
              </div>
              <div className="Total">
                <p>
