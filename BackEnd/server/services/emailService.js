...
async function sendVerificationEmail(email, code) {
    const mailOptions = {
        ...
        to: email,
        subject: "✨ Confirm Your Email - Reservation",
        html: `
            <div style="font-family: Arial, sans-serif; max-width: 600px; margin: auto; padding: 20px; border: 1px solid #ddd; border-radius: 10px; background-color: #f9f9f9;">
                <h2 style="color: #0056b3; text-align: center;">Welcome</h2>
                ...
                <br>
                <p style="font-size: 14px; text-align: center; color: #888;">© 2025 . All rights reserved.</p>
            </div>
        `
    };
